...
//
// Throughout the doc, replace 22.0.0.8 with the version number of Open Liberty, eg: 22.0.0.2-beta
// // // // // // // //

The link:{url-about}[Open Liberty] 22.0.0.8 includes the following beta features (along with all GA features):
...
// "The link:{url-about}[Open Liberty] 22.0.0.8 includes SUB_FEATURE_TITLE"
// // // // // // // //
...
----
dependencies {
    libertyRuntime group: 'io.openliberty.beta', name: 'openliberty-runtime', version: '[22.0.0.8,)'
}
----
