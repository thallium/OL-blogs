...
//
// Throughout the doc, replace 22.0.0.8-beta with the version number of Open Liberty, eg: 22.0.0.2-beta
// // // // // // // //

The link:{url-about}[Open Liberty] 22.0.0.8-beta includes the following beta features (along with link:{url-prefix}/docs/latest/reference/feature/feature-overview.html[all GA features]):
...
// "The link:{url-about}[Open Liberty] 22.0.0.8-beta includes SUB_FEATURE_TITLE"
// // // // // // // //
