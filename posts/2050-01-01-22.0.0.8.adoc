...
categories: blog
author_picture: https://avatars3.githubusercontent.com/tuo
author_github: https://github.com/tuo
...
// Replace tuo with your GitHub username eg: lauracowen
// Replace DESCRIPTION with a short summary (~60 words) of the release (a more succinct version of the first paragraph of the post).
// Replace gengchen with your name as you'd like it to be displayed, eg: Laura Cowen
//
